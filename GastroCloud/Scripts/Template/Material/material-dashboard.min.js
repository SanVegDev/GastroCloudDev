isWindows = $("html").addClass("perfect-scrollbar-off");
var breakCards = !0
    , searchVisible = 0
    , transparent = !0
    , transparentDemo = !0
...
$(document).ready(function () {
    ...
    , initDocumentationCharts: function () {
        if (0 != $("#dailySalesChart").length && 0 != $("#bar-week-chart").length) {
            dataDailySalesChart = {
                labels: ["01 - 07", "08 - 15", "16 - 23", "24 - 31"]
                , series: [[3900,37321,29000,36159]]
            ...
            new Chartist.Line("#bar-month-chart", dataDailySalesChart, optionsDailySalesChart), new Chartist.Line("#bar-week-chart", dataDailySalesChart, optionsDailySalesChart)
        }
    }
